...
if (foundProduct) {
   pushToDataLayer("view_item", {
      //? Event name is view_item while data is ecommerce important to know for google tag and analytics
      ecommerce: {
         items: [
            {
...
function handleAddToCart(product) {
   // 1. Create the dataLayer array if it doesn't exist
   window.dataLayer = window.dataLayer || [];

   // 2. Push the 'add_to_cart' event along with the ecommerce data
